...
public class Compilador {
    ...
    public Compilador() {
        this.verificaciones = new Verificaciones(tablaSimbolos, reporte);
        this.tablaAcciones = new TablaAcciones(reporte);
        AccionesSemanticas.registrar(tablaAcciones, verificaciones, reporte);
    }
    ...
    public void compilar(String rutaFuente) {
        ...
        Reporte.escribirArchivo(rutaFuente, "declaraciones.txt", verificaciones.contenidoDeclaraciones());
